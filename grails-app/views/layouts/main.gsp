...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="${request.contextPath}/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="${request.contextPath}/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="${request.contextPath}/vendor/morrisjs/morris.css" rel="stylesheet">
...
<script src="${request.contextPath}/vendor/raphael/raphael.min.js"></script>
<script src="${request.contextPath}/vendor/morrisjs/morris.min.js"></script>
<script src="${request.contextPath}/data/morris-data.js"></script>
